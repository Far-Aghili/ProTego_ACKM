...
def Token_val(E_D, token_Type, accessid_token, data):
    try:
        ...
        KEK_or_EKEK = Data_Analyser(data, flag, decoded)
...
def determine_escalation1():
    ...
    if header['AuthToken'] == 's.JvKotVPg3HlQ1ZpchK6xerB':
        ...
        return json.dumps(Token_val(E_D, token_Type, accessid_token, data))
    else:
